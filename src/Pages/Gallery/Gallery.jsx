const Gallery = () => {
  return (
    <div className="pb-60 pt-40">
      <div className="px-5  my-5 md:px-20">
      <h1 className="text-center text-3xl md:text-5xl font-bold">
        Our school Gallery
      </h1>
      <p className="md:text-xl text-center my-10 px-5">
        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus
        iusto vero sunt incidunt, vel quo velit quae ullam excepturi nihil
        nesciunt perspiciatis, veritatis totam ab modi, deserunt ad officia rem!
      </p>
      <main className="container mx-auto max-h-screen">
        <div className="grid justify-center items-center grid-cols-2 md:grid-cols-3 gap-4">
          <img
