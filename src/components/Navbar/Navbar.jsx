      ...
      <nav className="bg-white z-40 h-[80px] fixed top-0 left-0 right-0 px-10 shadow-md flex items-center justify-between">
        ...
        >
          <Link
            ...
            to="/" className="px-3 hover:text-slate-600 cursor-pointer">
            Home
          </Link>
          <Link
            onClick={() => setisOpen(!isOpen)}
          ...
          <Link
            onClick={() => setisOpen(!isOpen)}
            to="/result" className="px-3 hover:text-slate-600 cursor-pointer">
            Result
          </Link>
          <li onClick={handleDropDownone} className="flex items-center px-3 hover:text-slate-600 cursor-pointer">
            Admission <span className="ml-1">
              {
          ...
          </li>
          {
            isDropDown && (
              <ul className="absolute flex flex-col bg-white shadow-md ring-1 ring-gray-300 rounded-md top-14 right-16 md:right-28 z-50">
                <li onClick={handledropdownHidden}
                  //  onClick={() => setisOpen(!isOpen)}
                  className="px-4 py-3 hover:bg-orange-500 hover:text-white cursor-pointer text-sm rounded-md">Admission Form</li>
                <li
                  onClick={handledropdownHidden}
                  className="px-4 py-3 hover:bg-orange-500 hover:text-white cursor-pointer text-sm rounded-md">Admission Information</li>
              </ul>
            )
          }
          <Link onClick={() => setisOpen(!isOpen)} to="/quiz" className="px-3 hover:text-slate-600 cursor-pointer">Quiz</Link>
