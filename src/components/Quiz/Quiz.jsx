...
const Quiz = () => {
  const card = [
    {
      id: 7,
      icon: <PiNumberCircleSeven className="size-10" />,
      className: "Class Seven",
    },
    {
      id: 8,
      icon: <PiNumberCircleEight className="size-10" />,
      className: "Class Eight",
    },
    {
      id: 9,
      icon: <PiNumberCircleNine className="size-10" />,
    ...
    <div className="pb-5 pt-24 w-full min-h-screen px-2">
      <div className="text-center my-16 relative">
        ...
        <h2 className="text-xl text-gray-600 font-medium">
          Select your class and test your knowledge with engaging quizzes
          designed just for you!
        </h2>
      </div>
      <div className="container mb-32 mx-auto border flex flex-col bg-cover items-center md:flex md:flex-row md:justify-center gap-7 border-gray-300 rounded-lg p-4 shadow-lg bg-white py-10">
        {card.map((el, i) => {
          ...
          return (
            ...
            >
              <div className="pt-10">
                <div>
                  <span
                    className={`text-2xl inline-block ${color.textColor} ${color.bgColor} p-4 rounded-full`}
                  >
                    {el.icon}
                  </span>
                </div>
