...
const Register = () => {
  return (
    <div className="flex flex-col items-center justify-center h-[100vh]">
      <form className="bg-white flex flex-col p-5 shadow-md ring-1 ring-gray-400 rounded-md space-y-1">
        ...
        <div className="text-sm">
          ...
          <select className="ring-1 ring-gray-400 rounded px-2 py-1 w-full outline-0 focus:ring-2 focus:ring-blue-500 duration-200">
