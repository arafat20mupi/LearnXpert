...
import { MdEditDocument, MdMenu, MdUpload } from "react-icons/md";
...
const Sidebar = ({ toggle, open }) => {
  ...
  return (
    <div>
      <div
        className={`select-none h-screen pt-20 overflow-y-scroll border-1 shadow-md bg-white z-0 shadow-gray-500 w-[270px] top-0 left-0 right-0 fixed px-1 ${
          open
            ? "-left-[233px] md:-left-[0px] duration-500"
            : "-left-[0px] md:-left-[200px] duration-500"
        }`}
      >
        <ul className="flex flex-col space-y-2">
          <li className="flex items-center space-x-2 py-2 px-10 ml-auto">
            ...
            >
              <FaArrowAltCircleRight
                className={`text-slate-600 inline float-right md:text-2xl ${
                  open
          ...
          <div className="flex flex-col">
            ...
            {adminToggle && (
              <ul className="select-none text-sm my-1">
                <li className="py-2 ml-10 transform cursor-pointer hover:text-gray-700">
                  Add People
                </li>
                <li className="py-2 ml-10 transform cursor-pointer hover:text-gray-700">
                  Handle Fee's
          ...
          {isAdmin && (
            <li className="flex items-center space-x-2 hover:bg-orange-300 py-2 px-10">
